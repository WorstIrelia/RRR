./richochet_robots ./puzzle1.txt -max_moves 3 -visualize A
./richochet_robots ./puzzle1.txt -max_moves 3 -visualize B
./richochet_robots ./puzzle1.txt -max_moves 3 -visualize C
./richochet_robots ./puzzle1.txt -max_moves 9 -visualize A
./richochet_robots ./puzzle1.txt -all_solutions
./richochet_robots ./puzzle1.txt # one solution
./richochet_robots ./puzzle1.txt -max_moves 6 -all_solutions
./richochet_robots ./puzzle1.txt -max_moves 5 -all_solutions
